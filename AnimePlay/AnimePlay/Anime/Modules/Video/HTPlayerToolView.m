...
@implementation HTPlayerToolView
...
- (HTProgressSlider *)slider {
    
    if (!_slider) {
        
        HTProgressSlider * slider = [[HTProgressSlider alloc] initWithFrame:CGRectZero direction:HTSliderDirectionHorizonal];
        slider.enabled = NO;
        _slider = slider;
    }
    return _slider;
